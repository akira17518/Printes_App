...
(46, 1, NULL, '2023-09-08 03:55:47', 'hihi'),
(47, 1, 2, '2023-09-08 03:56:29', 'qua dep'),
(48, 1, 1, '2023-09-10 07:00:07', 'rewewrew'),
(49, NULL, 2, '2023-09-12 04:34:23', 'That is good idea\n\n\n\n\n'),
(66, 4, 2, '2023-09-12 05:06:16', 'beautifull'),
(67, 4, 3, '2023-09-12 05:30:22', 'wowow'),
(68, 4, 3, '2023-09-12 05:33:38', 'ukmm oh woow'),
(69, 4, 1, '2023-09-12 05:44:24', 'huhu'),
(70, 4, 1, '2023-09-12 05:54:36', 'ahahahahah'),
(71, 4, 6, '2023-09-12 11:04:38', 'hihi'),
(72, 4, 1, '2023-09-12 11:11:17', 'ough'),
(73, 4, 1, '2023-09-12 11:11:22', 'angry'),
(74, 4, 1, '2023-09-12 11:24:23', 'why'),
(75, 4, 6, '2023-09-13 10:29:05', 'oh sh!'),
(76, 4, 6, '2023-09-13 10:35:54', 'fsdfdsfds'),
(77, 4, 6, '2023-09-13 10:36:01', '243243244'),
(78, 4, 6, '2023-09-13 10:38:02', 'ểwr332r32'),
(79, 4, 6, '2023-09-13 10:38:23', 'brh'),
(80, 4, 6, '2023-09-13 10:38:24', 'fewfewre'),
(81, 4, 6, '2023-09-13 10:38:28', 'mach'),
(82, 4, 6, '2023-09-13 10:38:36', 'manoe'),
(83, 4, 3, '2023-09-14 03:16:10', 'valid'),
(84, 4, 3, '2023-09-14 03:56:13', 'ashem '),
(85, 4, 1, '2023-09-15 01:55:22', 'aaaaa'),
...
(152, 'anh0', 'http://localhost:8080/public/img/1695956053975_tim-hieu-giong-cho-samoyed-nguon-goc-dac-diem-cach-nuoi-bang-gia-202203291549425717.jpg', 'ffdsfdsf', 1),
(153, 'anh1', 'http://localhost:8080/public/img/1695956203962_khoahoclaptrinh.jpg', 'ffdsfdsf', 1),
(154, 'anh2', 'http://localhost:8080/public/img/1695960490370_khoahoclaptrinh.jpg', 'ffdsfdsf', 6),
(155, 'anh3', 'http://localhost:8080/public/img/1695986560913_khoahoclaptrinh.jpg', 'ffdsfdsf', 6),
(156, 'anh4', 'http://localhost:8080/public/img/1695988866880_fuhao.png', 'ffdsfdsf', 6);
...
(1, 'phanvana@gmail.com', '1245', 'phan văn a', 20, 'avatar1.jpg');
INSERT INTO `nguoi_dung` (`nguoi_dung_id`, `email`, `mat_khau`, `ho_ten`, `tuoi`, `anh_dai_dien`) VALUES
(2, 'user2@example.com', '$2b$10$UMGpPGczjdcaa9JC/Uua3uZvWB.xYlm1unExBoZ9cq9rt5jj67O2u', 'User Two', 27, 'avatar2.jpg');
INSERT INTO `nguoi_dung` (`nguoi_dung_id`, `email`, `mat_khau`, `ho_ten`, `tuoi`, `anh_dai_dien`) VALUES
(3, 'user3@example.com', 'password3', 'User Three', 31, 'avatar3.jpg');
INSERT INTO `nguoi_dung` (`nguoi_dung_id`, `email`, `mat_khau`, `ho_ten`, `tuoi`, `anh_dai_dien`) VALUES
(4, 'phanvana@ll.com', '$2b$10$8.JnUoCCrh1TkMx3O7hGnuqBZymoCnHYXB2RGXrTyjCizDrw/ymVm', 'phan văn a', 40, NULL),
(5, 'dovand@gmaill.com', '$2b$10$tLrybzEkG0fRLoquK2.QTOqmbCCbZJqV33c/uVn2b9GXv9e6P80b.', 'do van D', 29, NULL),
(6, 'dovant@gmail.com', '$2b$10$6EeWQa/ksRoyQN0QAwdbMOHVN69wVGhd1YRKwpMVYy1DAeOfYQPLK', 'do vann t', 25, NULL),
(7, 'dovant1@gmail.com', '$2b$10$WYtVd8rMniZx50KHb32Bfu7D8f/vtpyecjlAnDSDaY/ENMyZ0DWPu', 'do vann t', NULL, NULL);
